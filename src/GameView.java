...
public class GameView {
    ...
    private int bg1;
    private int bg2;
	String PersonImgPath = "..//CoolRun//img//person.png";  
	String BarrierImgPath="..//CoolRun//img//barrier.png";
	String FruitImgPath="..//CoolRun//img//fruit.png";
	String BackGroundImgPath="..//CoolRun//img//back1.png";
